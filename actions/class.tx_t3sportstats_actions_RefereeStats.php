...
class tx_t3sportstats_actions_RefereeStats extends tx_rnbase_action_BaseIOC {
	...
	public function handleRequest(&$parameters,&$configurations, &$viewData){
		...
		$types = Tx_Rnbase_Utility_T3General::trimExplode(',', $configurations->get($this->getConfId().'statisticTypes'), 1);
		if(!count($types)) {
	...
	private function findData($parameters, $configurations, $viewData, $type) {
		...
		self::handlePageBrowser($configurations, 
			...
			'searchcallback'=> array($srv, 'searchRefereeStats'),
			'pbid' => $type.'ps',
			)
		);
   ...
   */
	...
	function getTemplateName() { return 'refereestats';}
	function getViewClassName() { return 'tx_t3sportstats_views_RefereeStats';}
}

if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/t3sportstats/actions/class.tx_t3sportstats_actions_RefereeStats.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/t3sportstats/actions/class.tx_t3sportstats_actions_RefereeStats.php']);
}
