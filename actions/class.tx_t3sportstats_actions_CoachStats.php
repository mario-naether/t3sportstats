...
class tx_t3sportstats_actions_CoachStats extends tx_rnbase_action_BaseIOC {
	...
	private function findData($parameters, $configurations, $viewData, $type) {
		...
		self::handlePageBrowser($configurations, 
			...
			'searchcallback'=> array($srv, 'searchCoachStats'),
			'pbid' => $type.'ps',
			)
		);
   ...
   */
	...
	function getTemplateName() { return 'coachstats';}
	function getViewClassName() { return 'tx_t3sportstats_views_CoachStats';}
}

if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/t3sportstats/actions/class.tx_t3sportstats_actions_CoachStats.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/t3sportstats/actions/class.tx_t3sportstats_actions_CoachStats.php']);
}
