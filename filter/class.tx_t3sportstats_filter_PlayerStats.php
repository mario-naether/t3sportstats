...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/t3sportstats/filter/class.tx_t3sportstats_filter_PlayerStats.php']) {
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/t3sportstats/filter/class.tx_t3sportstats_filter_PlayerStats.php']);
}
